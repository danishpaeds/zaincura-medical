...
export const metadata = {
  ...
  description: 'Professional home blood collection Dubai. Certified phlebotomists visit your home for blood test sample collection. Same-day results available.',
