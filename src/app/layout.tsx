...
// Site-wide Organization and LocalBusiness Schema
const organizationSchema = {
  ...
  alternateName: ["Zain Cura", "Zain Cura Clinic", "Zain Cura Medical Centre"],
  ...
  image: [
    "https://www.zaincura.com/brand/logo.png",
    "https://images.unsplash.com/photo-1638202993928-7267aad84c31?w=1200&q=80"
  ],
  telephone: "+971-45703423",
  email: "info@zaincura.com",
  address: {
    "@type": "PostalAddress",
    streetAddress: "Al Ghurair Centre, 6th Floor, Office 607",
  ...
  hasMap: "https://maps.google.com/?q=25.2699,55.3181",
  ...
  availableService: [
    ...
    },
    {
      ...
      description: "Comprehensive blood tests with same-day results"
    },
    {
      "@type": "MedicalTherapy",
      name: "Home Medical Visits",
      description: "24/7 doctor home visits across Dubai"
    },
    {
      "@type": "MedicalTherapy",
      name: "IV Drip Therapy",
      description: "13 premium IV therapies for energy, immunity, and wellness"
    },
    {
      "@type": "MedicalTest",
      name: "Wellness Health Checks",
      description: "Comprehensive health screenings with smart digital reports"
    },
    {
      "@type": "MedicalTherapy",
      name: "Gynecology Services",
      description: "Female gynecologist for women's health and prenatal care"
    },
    {
      "@type": "MedicalTherapy",
  ...
  review: [
    {
      ...
      reviewBody: "Excellent medical care with professional staff. Same-day appointments and very convenient location."
    }
  ],
  sameAs: [
    "https://www.facebook.com/zaincura",
    "https://www.instagram.com/zaincura"
  ],
