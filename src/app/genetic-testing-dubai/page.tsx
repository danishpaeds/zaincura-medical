...
export const metadata = {
  ...
  description: 'Advanced genetic testing in Dubai. Hereditary cancer screening, pharmacogenomics, carrier testing, cardiovascular genetics. Personalized health insights with genetic counseling.',
