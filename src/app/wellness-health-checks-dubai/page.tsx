...
export const metadata = {
  ...
  description: 'Complete wellness health checks in Dubai with smart digital reports. 40+ biomarkers, same-day results, personalized health insights. Executive and preventive health packages available.',
