...
export const metadata = {
  ...
  description: 'Professional semen analysis in Dubai for fertility testing. WHO standards, same-day results, complete privacy. Male fertility assessment at Zain Cura Medical Center, Al Ghurair.',
