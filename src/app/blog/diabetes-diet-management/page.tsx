      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-6 rounded-r-lg">
            <p className="text-gray-700 leading-relaxed">
              <strong className="text-blue-900">Additional Support:</strong> In addition to nutrition counseling,
              we offer specialized{' '}
              <Link href="/iv-drip-therapy-dubai-clinic-home/diabetic-support-iv" className="text-blue-600 hover:text-blue-800 underline font-semibold">
                Diabetic Support IV Therapy
              </Link>{' '}
              with Alpha Lipoic Acid, Chromium, and B-Vitamins to support glucose metabolism and nerve health.
              This complementary therapy can help enhance energy levels and support overall diabetes management.
            </p>
          </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 mt-12">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="https://wa.me/971523011150?text=Hi%20%F0%9F%91%8B%20I%27m%20interested%20in%20Clinical%20Dietician%20consultation%20for%20Diabetes%20Management%20at%20Zain%20Cura.%20Please%20share%20available%20appointment%20slots." target="_blank" rel="noopener noreferrer">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/iv-drip-therapy-dubai-clinic-home/diabetic-support-iv">
              <Card className="clinical-card hover:scale-[1.02] transition-transform duration-200 border-blue-200 bg-blue-50/30">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-3 mb-3">
                    <Activity className="w-5 h-5 text-blue-600" />
                    <Badge className="text-xs bg-blue-600 text-white">IV Therapy</Badge>
                  </div>
                  <h4 className="font-semibold text-gray-900 mb-2">Diabetic Support IV</h4>
                  <p className="text-gray-600 text-sm">IV therapy with Alpha Lipoic Acid, Chromium & B-Vitamins to support glucose metabolism and nerve health.</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/iv-drip-therapy-dubai-clinic-home/energy-boost-fitness-support">
              <Card className="clinical-card hover:scale-[1.02] transition-transform duration-200">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 text-sm">Combat fatigue with NAD+, L-Carnitine, and B-complex for enhanced energy and recovery.</p>
                </CardContent>
              </Card>
            </Link>
          </div>
