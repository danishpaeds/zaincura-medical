      ...
      <div className="min-h-screen bg-white">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-purple-50 border-l-4 border-purple-500 p-6 mb-6 rounded-r-lg">
              <p className="text-gray-700 leading-relaxed">
                <strong className="text-purple-900">Boost Your Metabolism:</strong> For an added wellness boost, consider our{' '}
                <Link href="/iv-drip-therapy-dubai-clinic-home/nad-cellular-recharge-iv" className="text-purple-600 hover:text-purple-800 underline font-semibold">
                  NAD+ Cellular Recharge IV
                </Link>{' '}
                to enhance cellular energy and metabolism. We also offer{' '}
                <Link href="/iv-drip-therapy-dubai-clinic-home/energy-boost-fitness-support" className="text-purple-600 hover:text-purple-800 underline font-semibold">
                  Energy Boost IV Therapy
                </Link>{' '}
                with L-Carnitine and B-complex vitamins to support your weight management journey with improved energy levels and recovery.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-lime-50 rounded-xl p-8 mt-12">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="https://wa.me/971523011150?text=Hi%20%F0%9F%91%8B%20I%27m%20interested%20in%20Clinical%20Dietician%20consultation%20for%20Weight%20Management%20at%20Zain%20Cura.%20Please%20share%20available%20appointment%20slots." target="_blank" rel="noopener noreferrer">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <h3 className="text-xl font-bold text-gray-900 mb-6">Related Services & Articles</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link href="/iv-drip-therapy-dubai-clinic-home/nad-cellular-recharge-iv">
                <Card className="clinical-card hover:scale-[1.02] transition-transform duration-200 border-purple-200 bg-purple-50/30">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-3 mb-3">
                      <TrendingUp className="w-5 h-5 text-purple-600" />
                      <Badge className="text-xs bg-purple-600 text-white">IV Therapy</Badge>
                    </div>
                    <h4 className="font-semibold text-gray-900 mb-2">NAD+ Cellular Recharge</h4>
                    <p className="text-gray-600 text-sm">Advanced longevity therapy to restore cellular energy, boost metabolism, and support healthy aging.</p>
                  </CardContent>
                </Card>
              </Link>
              ...
              <Link href="/iv-drip-therapy-dubai-clinic-home/energy-boost-fitness-support">
                <Card className="clinical-card hover:scale-[1.02] transition-transform duration-200">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-3 mb-3">
                    ...
                    <h4 className="font-semibold text-gray-900 mb-2">Energy Boost IV Therapy</h4>
                    <p className="text-gray-600 text-sm">Maximize performance and accelerate recovery with NAD+, L-Carnitine, and B-complex.</p>
                  </CardContent>
                </Card>
              </Link>
            </div>
