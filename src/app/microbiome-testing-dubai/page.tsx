...
export const metadata = {
  ...
  description: 'Advanced microbiome testing in Dubai. Comprehensive gut health analysis, digestive wellness, IBS testing, SIBO analysis. Personalized probiotic and nutrition recommendations.',
