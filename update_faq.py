...
# Enhanced FAQ items
enhanced_faq = '''const enhancedFaqItems = [
  {
...
# Updated FAQ section HTML
enhanced_faq_section = '''        {/* Enhanced FAQ Section with Interactive Accordion */}
...
# Replace the old faqItems definition
content = re.sub(r'const faqItems = \[.*?\]', enhanced_faq, content, flags=re.DOTALL)

# Replace the old FAQ section
old_faq_pattern = r'        {/\* FAQ Section \*/}.*?        </section>'
content = re.sub(old_faq_pattern, enhanced_faq_section, content, flags=re.DOTALL)

# Replace faqItems references with enhancedFaqItems
content = content.replace('faqItems.map', 'enhancedFaqItems.map')
...
print("Enhanced FAQ successfully integrated!")
